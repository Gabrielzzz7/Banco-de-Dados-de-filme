...
TEST_CASE("01 - Teste de leitura de inteiro.")
{
    ...
    int result = ArquivosUteis::GerenciadorDeEntradas::lerInt();
...
TEST_CASE("03 - Teste de leitura de float.")
{
    ...
    float result = ArquivosUteis::GerenciadorDeEntradas::lerFloat();
...
TEST_CASE("05 - Teste de leitura de double.")
{
    ...
    double result = ArquivosUteis::GerenciadorDeEntradas::lerDouble();
...
TEST_CASE("07 - Teste de leitura string simples.")
{
    ...
    std::string result = ArquivosUteis::GerenciadorDeEntradas::lerString();
